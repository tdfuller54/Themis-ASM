...
def compMd(combo, assemblies, outbase, finalfolder):
    ...
    mdlines.extend([
                    ...
                    '<td style="vertical-align:bottom;border: none;text-align:center;"> ' + '<h4 align="center">Kmer Plot</h4> ' + f'<img src="{assemblies[1]}.spectra-asm.st.png" alt="Kmer spectrum plot">' + ' </td>',
                    '<td style="vertical-align:bottom;border: none;text-align:center;"> ' + '<h4 align="center">Kmer Plot</h4> ' + f'<img src="{assemblies[0]}.spectra-asm.st.png" alt="Kmer spectrum plot">' + ' </td>',
                    '</tr>',
                    '</table>',
                    '---',
                    ...
                    '</colgroup>',
                    '<tr style="border: none;text-align:center;">',
                    '<td style="vertical-align:bottom;border: none;text-align:center;"> ' + '<h4 align="center">Ideogram Error Windows</h4> ' + f'<img src="ideogram_errors.{assemblies[1]}.png" alt="Ideogram Error Windows">' + ' </td>',
                    '<td style="vertical-align:bottom;border: none;text-align:center;"> ' + '<h4 align="center">Ideogram Error Windows</h4> ' + f'<img src="ideogram_errors.{assemblies[0]}.png" alt="Ideogram Error Windows">' + ' </td>',
                    '</tr>',
                    '</table>',
...
#                    '<p id="pex">',
    ...
    mdlines.extend(['',
                    ...
                    '</colgroup>',
                    '<tr style="border: none;text-align:center;">',
                    '<td style="border: none;text-align:center;"> ' + '<h4 align="center">NG(X) Comparison Plot</h4> ' + f'<img src="{finalfolder}/combined_ngx_plot.png" alt="NG(x) plot of all assemblies">' + ' </td>',
                    '<td style="border: none;text-align:center;"> ' + '<h4 align="center">BUSCO Score Plots</h4> ' + f'<img src="{finalfolder}/combined_buscos.png" alt="BUSCO category plots">' + ' </td>',
                    '</tr>',
                    '</table>',
                    ''])
...
#                    '<p id="pex">',
    ...
    for a in assemblies:
        ...
        mdlines.extend(['<table style="width: 100%;height: 650px;border: none;">',
                       ...
                       '</colgroup>',
                       '<tr style="border: none;text-align:center;">',
                       '<td style="border: none;height:650px;text-align:center;"> ' + '<h4 align="center">Kmer Plot</h4> ' + f'<img src="{finalfolder}/{a}.spectra-asm.st.png" alt="Kmer spectrum plot">' + ' </td>',
