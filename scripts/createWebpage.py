...
def compMd(combo, assemblies, outbase, finalfolder):
    ...
    mdlines.extend([
                    ...
                    '</colgroup>',
                    '<tr style="border: none;">',
                    '<td style="vertical-align:bottom;border: none;"> ' + '<h4 align="center">Ideogram Error Windows</h4> ' + f'<img src="ideogram_errors.{assemblies[1]}.png" alt="Ideogram Error Windows">' + ' </td>',
                    '<td style="vertical-align:bottom;border: none;"> ' + '<h4 align="center">Ideogram Error Windows</h4> ' + f'<img src="ideogram_errors.{assemblies[0]}.png" alt="Ideogram Error Windows">' + ' </td>',
                    '</tr>',
                    '</table>',
...
#                    '<p id="pex">',
    ...
    mdlines.extend(['',
                    '---',
                    '',
                    '#### N(X) Plot and BUSCO Score Plots',
                    'The N(X\) plot is a measure of assembly continuity. The dotted line is the 50% mark of the anticipated assembly length. The higher the assembly\'s line is at this point, the more continuous the assembly.  ',
                    '  ',
                    ...
                    '</colgroup>',
                    '<tr style="border: none;">',
                    '<td style="border: none;"> ' + '<h4 align="center">N(X) Comparison Plot</h4> ' + f'<img src="{finalfolder}/combined_ngx_plot.png" alt="N(x) plot of all assemblies">' + ' </td>',
