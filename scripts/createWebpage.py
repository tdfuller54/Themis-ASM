...
#                    '<p id="pex">',
    ...
    mdlines.extend(['---',
                    ...
                    '<table>',
                    '<tr>',
                    '<td style="height:200px;width:400px"> ' + testHtml(tablines[0]) + ' </td>',
                    '<td style="height:200px;width:400px"> ' + f'<img src="{finalfolder}/combined_ngx_plot.png" alt="NG(x) plot of all assemblies" width="320" height="240">' + ' </td>',
                    '</tr>',
                    '</table>',
                    '---',
                    '<a name="asmqual"></a>',
